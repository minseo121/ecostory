...
function Sidebar() {
    return (
        <div className='bg-D3E7DD basis-1/6 h-screen top-16'>
            ...
            <div className='bg-EDF8F3 h-3/5 w-3/4 drop-shadow-md rounded-3xl mx-auto flex'>
                <div className='mt-[5%] text-589B7F flex-1 flex-wrap'>
                    <label htmlFor="all-check" className="mx-auto block text-center my-[8%]">
