        ...
        <div className="nav bg-white flex h-14 w-full drop-shadow-md fixed top-0 left-0 z-50">
            ...
            <div className="nav_contents flex flex-1 justify-end pr-4 my-auto">
                ...
                <ul className="hidden md:flex list-none pr-12 my-auto">
                    ...
                    <li className="ml-10">            
                        <Link to="/plan"><a className="text-[#498D80]" href="#">체크리스트 만들기</a></Link>       
                    </li>      
                    <li className="ml-10">            
                        <Link to="/checkliststate"><a className="text-[#498D80]" href="#">체크리스트 현황</a></Link>      
                    </li>   
                    <li className="ml-10">            
                        <Link to="/guide"><a className="text-[#498D80]" href="#">가이드북</a></Link>        
                    </li>   
                </ul>
            </div>
        </div>    
