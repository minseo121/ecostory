...
function Header() {    
    ...
    const showMoreItems = () => {
        setPrevPageData(currentWeekData.slice(currentPage * pageSize, (currentPage + 1) * pageSize));
                            ...
                            <div className='w-5/6 mx-auto h-full'>
                                ...
                                <div className='bg-[#EEF9F3] w-full h-1/4 rounded-xl drop-shadow-lg mb-16'>
                                    ...
                                    {currentWeekData.length === 0 ? (
                                        ...
                                        currentWeekData && currentWeekData.slice(currentPage * pageSize, (currentPage + 1) * pageSize).map((item, index) => (
                                            ...
                                            {currentWeekData.length < (currentPage + 1) * pageSize && currentWeekData.length != 0 &&(
                                                <button className="text-xl mr-6" onClick={showLessItems}> &lt; </button>
                                            )}
                                                {currentWeekData.length > (currentPage + 1) * pageSize && (
