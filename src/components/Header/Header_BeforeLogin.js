                    ...
                    <div className="absolute w-full top-0 left-0 mt-14 bg-white rounded-b-3xl drop-shadow-md text-[#498D80]">
                        ...
                        <form className="loginform mt-4 px-[7%] " onSubmit={handleSubmit}>
                            <div>
                                ...
                                <input type="text" className="input_id border-[3px] border-[#7BB49C] bg-[#EEF9F3] h-11 w-full my-2 p-4 px-5 rounded-xl" onChange={(e) => setId(e.target.value)} />
                            </div>
                            <div>
                                <p className="pl-1">비밀번호</p>
                                <div className='relative'>
                                    <input type={hide ? 'password' : 'text'} className="input_pw border-[3px] border-[#7BB49C] bg-[#EEF9F3] h-11 w-full my-2 p-4 px-5 rounded-xl" onChange={(e) => setPassword(e.target.value)} />
                                    {hide ? (
                            ...
                            {errorMessage && <p className="text-red-500 text-sm top-2 ">{errorMessage}</p>}
                            <div className="flex justify-end text-white mt-1 h-10"> 
                                <input type="submit" value="로그인" className="login_btn bg-[#7BB49C] rounded-xl px-9 hover:bg-[#589B7F] hover:cursor-pointer"/>                                
                            </div>
                        </form>
