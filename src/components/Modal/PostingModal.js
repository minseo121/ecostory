                        ...
                        <div className='modal_img my-auto ml-[15px]'>
                            <ImageUploading value={image} onChange={handleImageChange}>
                                {({ onImageUpload, onImageUpdate }) => (
                                    <button
                                        onClick={image.length === 0 ? onImageUpload : () => onImageUpdate(0)}
                                        {...props}>
                                        {croppedImage === null ? 
                                            <div className='h-[570px] w-[465px] bg-[#D9D9D9] text-[#589B7F] rounded-xl text-xl flex items-center justify-center'>이미지 업로드</div> :
                                            <div>
                                ...
                                <ImageUploading value={image} onChange={handleImageChange}>
                                    {({ onImageUpload, onImageUpdate }) => (
                                        <button
                                            ...
                                            {...props}>
                                            {croppedImage === null ? 
                                                <div className='h-full w-full bg-[#D9D9D9] text-[#589B7F] rounded-xl flex items-center justify-center'>이미지 업로드</div> :
                                                <div>
                                                    <img className="h-full w-full rounded-xl object-cover bg-[#D9D9D9]" src={croppedImage}/>
                                                </div>
                                            }
                                        </button>
                                    )}
